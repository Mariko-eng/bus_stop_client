...
class HelpScreen extends StatefulWidget {
  final Client client;
  const HelpScreen({Key key,this.client}) : super(key: key);
...
class _HelpScreenState extends State<HelpScreen> {
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  content: Text("Do Want To delete This Account?"),
                                  actions: [
                                    GestureDetector(
                                        onTap: () {
                                          Get.back();
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Get.back();
                                        enterPasswordDialog(email: widget.client.email);
                                      },
                                      child: Container(
                                        width: 80,
                                        height: 35,
  ...
  enterPasswordDialog({String email}){
    showDialog(
        context: context,
        builder: (context) {
              ...
              GestureDetector(
                onTap: () async {
                  if(_passwordCtr.text.trim().length > 5) {
                    Get.back();
                    await _userProvider2.deleteUserAccount(email: email,password: _passwordCtr.text.trim());
                  }else{
